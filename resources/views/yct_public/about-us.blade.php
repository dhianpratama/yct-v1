...
<!-- Mirrored from eazzy.me/html/imevent-multipage/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Sep 2016 04:24:30 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body id="home" class="wide body-light multipage multipage-sub">
        ...
        <div class="wrapper">
            ...
            <!-- Content area -->
            <div class="content-area" id="about-us">

            <!--TITLE & BROs-->
            <section class="page-section image breadcrumbs overlay">
                <div class="container">
                    <h1>Young Creative Thinkers</h1>
                    <ul class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        <li class="active">About YCT</li>
                    </ul>
                </div>
            </section>
            <!-- / TITLE & BROs-->
            ...
            <section class="page-section visi-misi">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 visi">
                            <h2>visi</h2>
                            <p>Young Creative Thinkers (YCT) merupakan tim kerja yang fokus bergerak dalam bidang pendidikan. YCT merupakan tempat bagi individu yang memiliki daya pikir kreatif yang tinggi untuk mewujudkan tujuan bersama.</p>
                        </div>
            ...
            <section class="page-section program-yct">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2>program<br>kami</h2>
                        </div>
                        <div class="col-md-6">
                            <p>Young Creative Thinkers (YCT) merupakan tim kerja yang fokus bergerak dalam bidang pendidikan. YCT merupakan tempat bagi individu yang memiliki daya pikir kreatif yang tinggi untuk mewujudkan tujuan bersama. Tim kerja YCT memiliki tujuan bersama, yaitu untuk memajukan sistem pendidikan di Indonesia dan meningkatkan kapasitas serta keterampilan para pelajar di Indonesia melalui program dan produk yang telah dirancang.</p>
                        </div>
            ...
            <section class="page-section tim">
                <div class="container">
                    <h2>tim kami</h2>
                    <div class="tim-member clearfix">
                        <div class="card no-border">
                            <div class="media">
                                <img src="assets/img/preview/dali.jpg" alt="">
                                <div class="caption hovered"></div>
                            </div>
                            <div class="caption">
                                <h3 class="caption-title">Nama Lengkap</h3>
                                <p class="caption-by">jabatan</p>
                                <div class="personel-link">
