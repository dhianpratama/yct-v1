...
<div class="tab-pane fade active in">
    <div class="row cards events">

        <div class="col-md-4 col-sm-6 isotope-item festival" v-for="e in events">
            <div class="card no-border">
                <div class="media">
                    <img style="width:254px; height:207px;"  v-bind:src="e.picture_url" alt="">
                ...
                <div class="caption">
                    <div class="caption-header">
                        ...
                        <!--<div class="header-bookmark btn">-->
                            <!--<i class="fa fa-bookmark-o"></i>-->
                        <!--</div>-->
                    </div>
                    <h3 class="caption-title"><a href="/event">@{{e.title}}</a></h3>
                    <p class="caption-category">by <a href="#">@{{e.organizer_name}}</a> </p>
                    <hr class="caption-divider">
                    <p class="caption-category caption-td"><i class="fa fa-clock-o time"></i> @{{displayDate(e.start_date)}} <br> <i class="fa fa-map-marker location"></i> @{{e.venue}} / @{{e.city}}</p>
