...
<head>
    ...
    <!-- Wrap all content -->
<div class="wrapper" id="vacancylistpage">
        ...
        <section id="content" class="content col-sm-8 col-md-9">
            ...
            <div id="list-view"  class="tab-pane fade active in" role="tabpanel">
                <div class="thumbnails events vertical">
                    <div v-for="e in vacancies" v-cloak>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-8">
                                    <div class="caption">
                                        ...
                                        <p class="caption-text">@{{e.job_description}}</p>
...
<div class="to-top"><i class="fa fa-angle-up"></i></div>
        ...
        <script src="assets/js/vue_modules/vacancy-list.app.js"></script>
